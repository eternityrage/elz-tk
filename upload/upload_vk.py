...
def upload_to_vk(video_path, description="", title=""):
    ...
    try:
        ...
        # Prepare message
        message = description if description else "✨ Elizabeth Olsen Daily!\n\n#elizabetholsen #hollywood #celebrity #fashion"
        ...
        video = upload.video(
            ...
            name=title or 'Elizabeth Olsen Daily Video',
...
def main():
    ...
    description = sys.argv[2] if len(sys.argv) > 2 else "Daily Elizabeth Olsen Moment! ✨"
    title = sys.argv[3] if len(sys.argv) > 3 else "Elizabeth Olsen Daily"
